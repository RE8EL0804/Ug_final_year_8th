...
class Model:
    ...
    def train(self, filepath, train_data, action_set):
        ...
        #print("aads model training completed and models saved with contamination:  " + str(action_set[0][2]))
    ...
    def test(self, filepath, test_data, action_set, ip_mod,
        ...
        def output(filename, temp):
            #file_exists = os.path.isfile("/Users/mac/Dropbox/aads/datastore/" + filename + "." + test_data + ".csv")
            #outfile = open("D:/college/proj/final/aads-master/srcmain/Datasets/NoPresence/Train/" + filename + test_data + ".csv", "a")
            outfile = open("../" + filename + test_data + ".csv", "a")
